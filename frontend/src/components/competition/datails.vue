<template>
                ...
                <div class="problem-header">
                  ...
                  <div class="problem-meta">
                    <div class="difficulty-tags">
                      ...
                      <el-tag size="small" type="info" effect="plain">通过率: 67.65%</el-tag>
                    </div>
                      ...
                      <div class="example-content">
                        ...
                        <div class="example-output">
                          <div class="example-row">
                            ...
                            <div class="content code-block">{{ example.output }}</div>
                          </div>
                        </div>
  ...
  import Solution from '@/components/problem/Solution.vue'
  import Submit from '@/components/problem/Submit.vue'
  ...
  export default {
    ...
    created() {
      // 使用比赛题目的API
      competition_problem_api.getProblemDetails(this.$route.params.competition_id, this.$route.params.problem_id)
        .then(response => {
          ...
          if (response && response.data) {
            ...
            this.problemData.examples = response.data.data.samples;
            console.log(this.problemData)
          }
        })
        .catch(error => {
          console.error('获取比赛题目详情失败:', error);
    ...
    return {
      ...
      competitionId: this.$route.params.competition_id,
      pollTaskId: null,
      problemData: {
    ...
    handleSubmit() {
      ...
      problem_api.ProblemSubmit(this.problemId, this.code, this.language, this.store.user.username,this.competitionId)
        .then(res => {
